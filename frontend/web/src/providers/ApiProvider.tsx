  ...
  return (
    <div className="mx-auto mt-16 max-w-md rounded-2xl border border-outline-variant/50 bg-surface p-6 text-center shadow-soft">
      ...
      <p className="mt-2 text-sm text-muted">
        {context} needs the Kafe Eman API. Set <code className="rounded bg-cream px-1">VITE_API_URL</code>{' '}
      ...
      <p className="mt-2 text-sm text-muted">
        Start the backend with <code className="rounded bg-cream px-1">bun run api</code> from the
        project root.
      </p>
    </div>
  );
