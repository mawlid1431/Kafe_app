...
iOS and Android run the **same code against the same Convex deployment** — there is
no second copy of the app. A change made in the admin dashboard appears live on
both platforms, because both subscribe to the same Convex queries.
